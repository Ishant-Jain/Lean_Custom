...
{
    public class Two_Days_Momentum_Strategy : QCAlgorithm
    {
        ...
        public void Calc_Perc()
        {
            ...
            day_1 = Time - TimeSpan.FromDays(2);
            day_2 = Time - TimeSpan.FromDays(1);
            foreach (var symb in symbollist)
            {
                ...
                if (day_1_close != 0 && day_2_close != 0 && current_close != 0)
                {
                    ...
                    second_perc_gain = (current_close / day_2_close - 1) * 100;
